...
$strings =
	'tinyMCE.addI18n( 
		"' . $mce_locale . '.bctt",
			{
			toolTip : "' . esc_js( _x( 'Better Click To Share Shortcode Generator', 'Text that shows on mouseover for visual editor button', 'better-click-to-tweet' ) ) . '",
			windowTitle : "' . esc_js( _x( 'Better Click To Share Shortcode Generator', 'Text for title of the popup box when creating a shareable quote in the visual editor', 'better-click-to-tweet' ) ) . '",
