        ...
        <svg class="fill-current text-blue-500 w-6 mr-2" viewBox="0 0 20 20">
                    ...
                    <a class="text-sm font-bold text-blue-500" href="https://dashboard.mailerlite.com/forms/319685/79491316893877812/share" target="_blank" rel="nofollow noopener noreferrer"> <?php _e( 'Subscribe Today', 'better-click-to-tweet' ); ?> </a></strong></p>
        </div>
