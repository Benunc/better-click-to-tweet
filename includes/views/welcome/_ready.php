<div id="bctt-copy" class="text-gray-600 my-16">
        <svg 
            class="text-teal-400 fill-current w-32 mx-auto"
...
<h2 class="text-center text-lg mb-4 pb-2 text-gray-600 font-bold border-b border-solid border-gray-200">
