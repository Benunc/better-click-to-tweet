        <div id="bctt-copy" class="text-gray-600">
            ...
            <div id="bctt-instructions">
                <p class="mb-4">
                    <?php _e( 'This plugin has a ton under the hood to maximize the sharing of your posts on X. If you\'re using the classic editor, many of those features are more hidden. ', 'better-click-to-tweet' )?>
                </p>
